...
| 04 Archivo | Fuentes editables y vistas sustituidas o retiradas | Conservar la ruta relativa anterior bajo una revisión identificada; usar `04 Archivo/Retirados` para contenido incompatible y actualizar índice y consumidores |
...
La [estructura vacía](../../../paquete_fundacional/v0.6/LEEME.md) se distribuye como ZIP independiente, con instrucciones y una plantilla de índice. Prepararla es una operación documental; no habilita contratación, contacto ni actuación comercial por sí sola.
...
Usar `ID - Go2Rev - Titulo - vN.ext` para las fuentes de trabajo, con identidad estable por pieza y título comprensible. Una vista destinada al cliente puede adaptar su título si la fuente y el índice conservan Go2Rev y la versión del paquete. La versión identifica contenido; el estado se registra en el documento y en el índice. Los originales externos mantienen su nombre recibido siempre que sea posible y obtienen su ID en FUE. E y O describen el uso habilitado, no una numeración de versiones ni carpetas nuevas.
...
Un artefacto gobernado por otra metodología o por una premisa incompatible se conserva en `04 Archivo/Retirados`. Su primera línea e índice indican **RETIRADO**, fecha, causa y alcance. No se usa como entrada; se recorren sus consumidores antes de cerrar la retirada.
