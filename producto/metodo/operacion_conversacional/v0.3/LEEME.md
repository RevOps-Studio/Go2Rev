...
Versión base 0.3 · Integración del conjunto 0.4

Para empezar, usar [entrada](ENTRADA_GO2REV.md) e [invariantes](13_invariantes.md), reunidos con los criterios de suficiencia en CARGA_INICIO. Añadir la carga del nodo y abrir las secciones de extensión cuando se active su condición. [Primera pasada](10_primera_pasada.md) es una vista del mapa y la [definición de campos](../../esquema/v0.1/LEEME.md).
