...
La prestación comienza desde un encargo delimitado. Si mercado o segmento deben determinarse mediante Diagnostic, no se exigen resueltos de antemano. Si aún se está preparando el encargo, N01 permite definir ámbito, valor de la evaluación, salida y autoridad sin fingir que la contratación ya existe. El método completo se aplicará cuando haya cerrado la construcción fundacional; estas instrucciones no abren una prestación durante el desarrollo.
