# Go2Rev · Definir oferta y precio
...
- producto/metodo/oferta_entrega_y_economia/v0.1/modelo/Go2Rev_modelo_economico_v0.2.xlsx
- producto/metodo/oferta_entrega_y_economia/v0.1/modelo/definicion_modelo.json
- producto/metodo/oferta_entrega_y_economia/v0.1/plantillas/05_modelo_y_conclusion.md
- producto/metodo/oferta_entrega_y_economia/v0.1/plantillas/06_comparacion.md
...
**Primera pasada.** Definir unidades y alcance, comparar configuración y mecanismo de cobro, triangular coste, alternativas y valor, proponer importe o regla y condiciones.

**Núcleo de K08.** Unidad y destinatario; alcance; métrica de precio; fundamento; neto y condiciones; recepción y estado.

**Cierre y ampliación.** En exploración, guardar la representación en Diagnostic y mantener la economía en su fuente única; para uso concreto comprobar autoridad y preparación pertinentes.
...
## Fuente: producto/metodo/oferta_entrega_y_economia/v0.1/01_oferta_y_precio.md

SHA256: 04007b9975cb764600730080755e9b72f18341b7e2530f4e2aad1cfb607f2a3c

# N08 · Oferta y precio

Versión 0.1 · Productor de K08

Empezar con la primera pasada de N08 (archivo adicional: producto/metodo/operacion_conversacional/v0.2/10_primera_pasada.md#n08) y aplicar núcleo y suficiencia (archivo adicional: producto/metodo/operacion_conversacional/v0.2/12_nucleo_y_suficiencia.md). El procedimiento y contrato siguientes gobiernan el análisis completo.
...
## Fuente: producto/metodo/oferta_entrega_y_economia/v0.1/plantillas/01_oferta.md

SHA256: e4dd120a41cbcb061aef8a4a7780dd3107e9eaa6dc4d524e2f264e35ee15a90c

# Plantilla · K08 Oferta y precio

Versión 0.1 · Campos sin contenido de prestación · [Instrucción](#fuente-1)
...
SHA256: ee3ba66917c1279644a5d69a8d410cb40f331839ac3ce666b4bc78f96399bfbd

# Guía del modelo económico editable

Libro y guía v0.2 · Uso futuro del libro vacío (archivo adicional: producto/metodo/oferta_entrega_y_economia/v0.1/modelo/Go2Rev_modelo_economico_v0.2.xlsx)

## Contrato de uso

El libro es una representación de cálculo de K12 para **una combinación y revisión**, con un periodo económico y calendarios explícitos. Se acompaña de la plantilla de modelo y conclusión (archivo adicional: producto/metodo/oferta_entrega_y_economia/v0.1/plantillas/05_modelo_y_conclusion.md). El contrato contiene naturaleza de entradas, unidades, procedencia, inclusiones, límites, hipótesis y decisión; el libro no reemplaza ese razonamiento.
...
9. Registrar resultados parciales, incompatibilidades y conclusión en K12; comparar configuraciones según la [instrucción de comparación](#fuente-6). Cada fuente calculada conserva parámetros y revisión; el libro no presenta comparaciones simultáneas ni capturas como si se actualizaran solas. Un cambio obliga a actualizar las fuentes y la comparación dependiente.
...
El núcleo no optimiza mezcla, planifica fechas, elige tramos ni valora inventario. Tampoco infiere adquisición, abandono, aceptación de precio o valor futuro. Las [fórmulas generales](#fuente-4) y [variantes](#fuente-5) establecen cómo resolver las relaciones adicionales pertinentes. Si falta una adaptación material, la conclusión dependiente permanece limitada.

Las fuentes generales son esta especificación y la definición editable del libro (archivo adicional: producto/metodo/oferta_entrega_y_economia/v0.1/modelo/definicion_modelo.json), ambas dentro del producto. La herramienta de generación (archivo adicional: herramientas/modelo_economico/LEEME.md) utiliza esa definición actual con Python y openpyxl. No requiere originales históricos ni un libro anterior para regenerar el original vacío.
