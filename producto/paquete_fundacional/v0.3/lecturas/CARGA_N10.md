# Go2Rev · Diseñar compra y traspasos
...
**Primera pasada.** Reconstruir decisiones del comprador, separar pertinencia e intención, definir transiciones, retorno, excepciones y recepción.

**Núcleo de K10.** Objeto y estado; criterio discriminante; acción y responsable; evidencia de evento; siguiente receptor; coste y cierre.

**Cierre y ampliación.** Ajustar cadencia a ventana de compra, permiso y capacidad; antes de automatizar comprobar sus eventos, excepciones y autoridad.
...
## Fuente: producto/metodo/posicionamiento_demanda_y_conversion/v0.1/03_conversion_y_compra.md

SHA256: 218e598042980c81059574bc71c19368bba44062081420b276fb4936715e39b7

# N10 · Conversión y recorrido de compra

Versión 0.1 · Productor de K10

Empezar con la primera pasada de N10 (archivo adicional: producto/metodo/operacion_conversacional/v0.2/10_primera_pasada.md#n10) y aplicar núcleo y suficiencia (archivo adicional: producto/metodo/operacion_conversacional/v0.2/12_nucleo_y_suficiencia.md). El procedimiento y contrato siguientes gobiernan el análisis completo.
...
Si existen datos pertinentes durante una prestación y la decisión requiere una estimación, usar las [reglas de cohortes y dominio](#fuente-5). Separar cantidades acordadas, decisiones abiertas y resultados hipotéticos, con fecha de corte, evidencia y límites. No es obligatorio producir forecast para poder diseñar un proceso ni sumar todos los acuerdos potenciales como capacidad comprometida.
...
## Fuente: producto/metodo/posicionamiento_demanda_y_conversion/v0.1/plantillas/04_recorrido_y_transicion.md

SHA256: c61e47911cbfd3a73e1fb55dea35bb6b211e71f60e3b7d437eff12d072d36f34

# Plantilla de recorrido y transición de compra

Versión 0.1 · K10 · Campos empresariales vacíos

Usar con [conversión y compra](#fuente-1) y [variantes y traspasos](#fuente-6). Definir solo etapas y ramas que representen decisiones o controles necesarios. Repetir el bloque de transición dentro de K10; no fija etapas, probabilidades ni número de contactos.
...
La plantilla K11 de entrega y traspaso (archivo adicional: producto/metodo/oferta_entrega_y_economia/v0.1/plantillas/02_entrega_y_traspaso.md) conserva el contrato de cumplimiento. La [recepción y seguimiento](#fuente-4) desarrolla asignación y devoluciones comerciales sin duplicar ese contrato.

## Aplicabilidad de los bloques

Antes de emitir K10, completar el núcleo de N10 Diseñar compra y traspasos (archivo adicional: producto/metodo/operacion_conversacional/v0.2/10_primera_pasada.md). Las reglas CONTR, EVAL, USO y de variante de esta plantilla mantienen su momento de exigibilidad. Un bloque condicional se completa cuando afecte al resultado; documentar la condición que lo hace aplicable o su exclusión. Una ausencia material queda localizada y limita el uso dependiente. La cabecera común se registra una vez por artefacto.


<a id="fuente-4"></a>

## Fuente: producto/metodo/posicionamiento_demanda_y_conversion/v0.1/plantillas/06_recepcion_y_seguimiento.md

SHA256: ff8142373a3a1c070c83a72d34a4687e3796bccfb2d2ae3248b3feff541da500

# Plantilla de recepción, devolución y seguimiento

Versión 0.1 · K09 → K10 y transiciones K10 · Campos empresariales vacíos

Usar con [conversión y compra](#fuente-1). Repetir para traspasos que cambien tarea o responsabilidad. La recepción de un archivo o una notificación emitida no acredita que el receptor pueda asumir el compromiso.

| Campo | Regla | Valor |
|---|---|---|
| Referencia | K09/K10, sección/revisión, autor, fecha y estado documental | |
| Encargo y uso | K01/revisión, ámbito y uso E/O | |
| Objeto e identidad | Unidad de compra, ocasión, pedido o evento; regla de enlace y deduplicación | |
| Origen y señal | Ruta/campo/revisión y evento observado o hipotético, conservando su naturaleza | |
| Información transmitida | Oferta/revisión, situación, evidencias, condiciones, límites y siguiente decisión | |
| Emisor | Responsable de origen y tarea que termina; frontera de actividad/coste | |
| Receptor y competencia | Responsable de siguiente tarea, disponibilidad y medio; criterio de asignación y respaldo | |
| Autoridad | Compromiso que puede asumir y condiciones que debe elevar a otro decisor | |
| Ajuste e intención | Criterios por separado y evidencia pertinente; desconocido no se transforma en incumplimiento | |
| Condición de recepción | Campos/evidencias necesarios, medio y qué acredita el acuse | |
| Disposición | Admitido, admitido con límites o devuelto; motivo concreto, productor y corrección requerida | |
| Plazo de respuesta | Inicio/fin del reloj, calendario/zona, cobertura y capacidad; separar respuesta y resolución | |
| Acción posterior | Decisión o tarea útil, responsable, entrada/salida y condición de finalización | |
| Pendencia | Qué falta, quién puede resolverlo, compromiso limitado y trabajo independiente permitido | |
| Devolución | Motivo de compra/servicio, evidencia y nodo que corrige; preservar contexto para evitar reinicio inútil | |
| Seguimiento | Utilidad para el comprador, permiso, criterio de momento y carga de cada intento | |
| Silencio o cierre | Qué se sabe y qué no; condición para pausar/cerrar sin atribuir una causa no observada | |
| Reapertura | Cambio relevante, evidencia nueva y permiso; evitar contar la misma ocasión como nueva adquisición por defecto | |
| Conflictos y repetición | Fuente autorizada para conciliar estados; evento repetido no debe duplicar aceptación, cobro, pedido o entrega | |
| Carga y registro | Actividad incluida aunque no avance; referencia a partida/recurso y evento para N12/N13 | |
| Límite de entrega | Si inicia cumplimiento, referencia al contrato K11, condiciones de inicio y recepción de operación | |
| Preparación requerida | Medios/CAP, material, tarea crítica y criterio para N15/N16; pendiente no equivale a comprobado | |
| Cambios y continuidad | Consumidor/campo/revisión, CAM y condiciones de actualización antes del siguiente compromiso | |

Para aceptación comercial e inicio de cumplimiento, usar el bloque de entrega y traspaso K11 (archivo adicional: producto/metodo/oferta_entrega_y_economia/v0.1/plantillas/02_entrega_y_traspaso.md). No copiarlo como un contrato comercial alternativo. Los hechos de una prestación se preservarán con la versión que los sustentó.
