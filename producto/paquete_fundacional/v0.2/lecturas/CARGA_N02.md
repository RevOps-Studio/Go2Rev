# Go2Rev · Convertir originales en conocimiento
...
- producto/metodo/encargo_y_conocimiento/v0.1/LEEME.md
...
**Primera pasada.** Leer por pregunta, identificar fuentes, extraer afirmaciones, reconciliar discrepancias y asignar huecos a investigación o aportación exclusiva.

**Núcleo de K02.** Representación; ámbito; fuentes y cobertura; afirmaciones con naturaleza; capacidades o transferencia; huecos y siguiente uso.

**Cierre y ampliación.** Cerrar la primera pasada cuando el consumidor pueda identificar qué sabe, qué debe investigar y qué impide su decisión.

**Destino.** 00 Sistema y 02 Anexos. Aplicar fuente editable, vista e índice de la convención común.
...
Las salidas se recogen en [conocimiento](#fuente-4), [solicitudes](#fuente-3), [transferencia A](#fuente-5) o [capacidades B](#fuente-6). Los [contratos y el diccionario](#fuente-2) definen cómo se consumen.
...
Trabajar por elemento que pueda cambiar la decisión: necesidad, situación y roles de compra, alternativa, acceso, promesa/precio, entrega/cobro o recurso indispensable. La [matriz A](#fuente-5) recoge únicamente los elementos pertinentes al ámbito.
...
La [matriz B](#fuente-6) alimenta N06 y las representaciones exploratorias de N08–N12. Si una oferta combina recursos existentes y nuevos, conserva esas diferencias dentro de B. La ruta solo cambia si cambia la iniciativa de K01; no se añade A por disponer de cualquier activo previo.
...
## Fuente: producto/metodo/encargo_y_conocimiento/v0.1/03_contratos_y_diccionario.md

SHA256: f339fcc2568ee7a41d224ade15b1f217fa4bb7e199cd4c7df0c96e8a3841acf8
...
Antes de consumir una entrada, el analista receptor comprueba identidad, revisión, ámbito/unidades, vigencia y suficiencia para su decisión. Registra la relación cuando el campo sostenga una conclusión o compromiso material; no registra cada frase del documento. La [plantilla de decisiones y cambios](#fuente-7) incluye esta relación.
...
## Fuente: producto/metodo/encargo_y_conocimiento/v0.1/plantillas/02_solicitudes.md

SHA256: e8e442787e974b60cf7b975f8bb316ced264285d63325e3e3ab4dfd02c84ba15

# Plantilla · Solicitud selectiva y recepción

Versión de plantilla 0.1 · Campos de prestación vacíos

Usar con [N02](#fuente-1) y [diccionario](#fuente-2). Cada bloque describe una SOL repetible. El asistente lo redacta después de revisar lo disponible. La columna Valor queda vacía en la fuente metodológica.
...
Antes de emitir K02, completar el núcleo de N02 Convertir originales en conocimiento (archivo adicional: producto/metodo/operacion_conversacional/v0.2/10_primera_pasada.md). Las reglas CONTR, EVAL, USO y de variante de esta plantilla mantienen su momento de exigibilidad. Un bloque condicional se completa cuando afecte al resultado; documentar la condición que lo hace aplicable o su exclusión. Una ausencia material queda localizada y limita el uso dependiente. La cabecera común se registra una vez por artefacto.


<a id="fuente-4"></a>

## Fuente: producto/metodo/encargo_y_conocimiento/v0.1/plantillas/03_conocimiento.md

SHA256: 80bb3f04c16860d263b9adf102b5568a222303247eb71fb62d27a3d869c4e955

# Plantilla · Base de conocimiento K02

Versión de plantilla 0.1 · Campos de prestación vacíos

Usar con [N02](#fuente-1) y [contratos](#fuente-2). Las reglas son metadatos; no son afirmaciones de una prestación. Repetir únicamente los registros pertinentes a decisiones materiales. Los bloques pueden separarse en archivos enlazados sin duplicar el contenido.
...
## Fuente: producto/metodo/encargo_y_conocimiento/v0.1/plantillas/04_transferencia_A.md

SHA256: 454bf3b13b3818f3095d936f2e9604ac0034ac920b9cd4cc03e23b9143b6ee72

# Plantilla · Transferencia de oferta a contexto nuevo

Versión de plantilla 0.1 · Recorrido A · Campos de prestación vacíos

Usar con [N02, recorrido A](#fuente-1). Repetir el bloque por elemento material que se pretenda trasladar. El analista produce la comparación y el consultor revisa la inferencia. Los datos conservan su AF, ámbito y revisión; esta matriz no duplica el registro de afirmaciones.
...
## Fuente: producto/metodo/encargo_y_conocimiento/v0.1/plantillas/06_decisiones_y_cambios.md

SHA256: 62b9529f6cf0d145186f5bc00c93e06b0ce97de7216a8fc84d4c9de46c37660e

# Plantilla · Decisiones, artefactos, consumo y cambios

Versión de plantilla 0.1 · Campos de prestación vacíos

Usar con [contratos y diccionario](#fuente-2). Son registros de una prestación. La columna Valor permanece vacía en el producto. Repetir solo por decisiones, entregas y dependencias materiales; pueden convivir en un índice compartido con K01/K02.
