# Go2Rev · Preparar obligaciones y evidencia
...
- producto/metodo/medicion_preparacion_y_transferencia/v0.1/05_comprobacion_de_preparacion.md
- producto/metodo/medicion_preparacion_y_transferencia/v0.1/plantillas/06_observacion_y_correccion.md
...
**Primera pasada.** Precisar capacidad recibible, piezas y recursos; fijar criterio previo y ordenar preparación, observación y decisión.

**Núcleo de K14.** Obligación/pregunta; pieza y destinatario; criterio; recursos/autoridad; procedimiento; condición de cierre.

**Cierre y ampliación.** Para obtención ligera conservar solo los campos aplicables. Fijar los criterios del alcance autorizado antes de producir y comprobar sus piezas.

**Destino.** 01 Entregables/Despliegue y 03 QA. Aplicar fuente editable, vista e índice de la convención común.
...
## Fuente: producto/metodo/medicion_preparacion_y_transferencia/v0.1/02_preparacion_y_secuencia.md

SHA256: 2694fbd79f08424c1810187a70adf6fc84e5192111bb03eab9f748f3d34e2d4b

# N14 · Preparación, protocolos y secuencia

Versión 0.1 · Productor de K14

Empezar con la primera pasada de N14 (archivo adicional: producto/metodo/operacion_conversacional/v0.2/10_primera_pasada.md#n14) y aplicar núcleo y suficiencia (archivo adicional: producto/metodo/operacion_conversacional/v0.2/12_nucleo_y_suficiencia.md). El procedimiento y contrato siguientes gobiernan el análisis completo.
...
4. **Elegir evidencia adecuada.** Usar la tabla siguiente y los protocolos de evidencia (archivo adicional: producto/metodo/medicion_preparacion_y_transferencia/v0.1/03_protocolos_de_evidencia.md). Declarar qué puede concluirse y qué queda fuera. Una revisión documental puede detectar un defecto suficiente para detener el uso, aunque no sea suficiente para acreditar preparación completa.
5. **Fijar protocolo previo.** Precisar pregunta/proposición, versión/ámbito, entradas, procedimiento, ejecutor, recurso, criterio, rastro, límites y decisión posterior. La [plantilla de protocolo](#fuente-4) es común; se completa con el procedimiento pertinente, no solo con su título.
...
## Fuente: producto/metodo/medicion_preparacion_y_transferencia/v0.1/plantillas/03_preparacion_y_secuencia.md

SHA256: 741c92db78777c51e6eeb74f2cc62e31c7b97d38109c1f7aa26daafb89788b0b

# Plantilla de obligación, preparación y secuencia

Versión 0.1 · K14 · Campos empresariales vacíos

Usar con [preparación y secuencia](#fuente-1). Repetir por obligación/tarea pertinente dentro del encargo. La secuencia futura de prestación no constituye backlog del desarrollo de Go2Rev.

| Campo | Regla | Valor |
|---|---|---|
| Referencia | K14/sección/revisión, autor, fecha, ubicación y estado documental | |
| Encargo y ámbito | K01/revisión, destinatario, recorrido/variante y uso E/O | |
| Motivo de preparación | Obligación contratada, evidencia para decisión abierta o ambas; localizador | |
| Decisión habilitada | K06/DEC o pregunta exploratoria delimitada sin exigir K06 final | |
| Capacidad recibible | Qué debe poder hacerse, por quién y con qué condición de finalización | |
| Tarea y recorrido | Entrada, acción/decisión, salida, receptor y excepción material | |
| Contenido productor | K07–K13/campo/revisión y criterio admitido; carencias explícitas | |
| Pieza o medio | Función y localizador si existe; conservar, adaptar, producir o configurar | |
| Tipo de evidencia | Mercado/proceso, conducta comercial, cálculo/archivo, captura o uso; límite de conclusión | |
| Protocolo | Referencia a procedimiento y versión de criterio previo; qué cubrirá | |
| Dependencia de inicio | Productor, condición verificable y qué trabajo puede avanzar mientras falta | |
| Orden y prioridad | Precedencias, consecuencia de error, valor de información y coste de esperar/actuar | |
| Trabajo completo | Producción, preparación, ejecución, análisis, corrección y traspaso pertinentes | |
| Recurso y calendario | Competencia, CAP, disponibilidad neta y distribución temporal; asignación nominal distinta de efectiva | |
| Economía | Referencias de partidas/carga K12, ámbito, reconocimiento/pago y conciliación sin doble coste | |
| Acceso y autoridad | Permisos por acción, responsable y vigencia; no pedir de nuevo autoridad suficiente | |
| Condición de preparado | Entradas, versiones, personas, medios y observación efectivamente disponibles | |
| Límites | Gasto/esfuerzo/tiempo/exposición pertinentes y fundamento; desconocidos necesarios impiden esa ejecución | |
| Interrupción o ampliación | Condición de detener, responsable y autoridad para cambiar el compromiso | |
| Criterio de recepción | Obligación y evidencia necesaria; no exigir venta como cierre universal | |
| Alternativa o carencia | HUE/CON, efecto, opción suficiente y productor | |
| Acompañamiento | Trabajo del consultor/operador, soporte previsto y condición de fin conforme a K01 | |
| Consumidores y revisión | K15/K16/K17 o N06, campo/revisión, disposición y CAM pertinente | |

El [protocolo previo](#fuente-4) desarrolla la actuación cuando proceda. Identificar una pieza en esta tabla no significa que esté materializada ni comprobada.

## Aplicabilidad de los bloques

Antes de emitir K14, completar el núcleo de N14 Preparar obligaciones y evidencia (archivo adicional: producto/metodo/operacion_conversacional/v0.2/10_primera_pasada.md). Las reglas CONTR, EVAL, USO y de variante de esta plantilla mantienen su momento de exigibilidad. Un bloque condicional se completa cuando afecte al resultado; documentar la condición que lo hace aplicable o su exclusión. Una ausencia material queda localizada y limita el uso dependiente. La cabecera común se registra una vez por artefacto.


<a id="fuente-4"></a>

## Fuente: producto/metodo/medicion_preparacion_y_transferencia/v0.1/plantillas/04_protocolo_previo.md

SHA256: ffbe8c89236ac7b226b042e438c7ca10b041b4d6d202594aa79924d405ce29ec

# Plantilla de protocolo previo

Versión 0.1 · Sección K14 · Campos empresariales vacíos

Usar con obtención de evidencia (archivo adicional: producto/metodo/medicion_preparacion_y_transferencia/v0.1/03_protocolos_de_evidencia.md) o comprobación de preparación (archivo adicional: producto/metodo/medicion_preparacion_y_transferencia/v0.1/05_comprobacion_de_preparacion.md), según la pregunta. El protocolo debe incorporar el procedimiento pertinente y su adaptación de alcance; escribir solo su nombre no lo completa. Su ejecución es posterior a la construcción íntegra del método.
...
Fijar estos criterios antes de la observación. La plantilla de observación (archivo adicional: producto/metodo/medicion_preparacion_y_transferencia/v0.1/plantillas/06_observacion_y_correccion.md) conservará después el resultado sin modificar el protocolo retrospectivamente.
