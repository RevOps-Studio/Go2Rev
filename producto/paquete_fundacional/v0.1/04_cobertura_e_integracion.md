...
Versión de conjunto 0.1 · Correspondencia de producto

Este mapa relaciona obligaciones de arquitectura con las instrucciones que las desarrollan. Orienta la revisión documental y la selección de piezas; no sustituye sus procedimientos, crea otro plan maestro ni acredita ejecución. La arquitectura mantiene los diecisiete nodos y la [correspondencia con los once pasos de origen](../../arquitectura/v0.2/05_reutilizacion_y_fuentes.md).
...
Las guías de componente enlazan sus plantillas vacías. Los contratos comunes se mantienen en [FND02](../../metodo/encargo_y_conocimiento/v0.1/03_contratos_y_diccionario.md), [FND03](../../metodo/investigacion_y_diagnostic/v0.2/06_contratos_y_economia_exploratoria.md), [FND04](../../metodo/oferta_entrega_y_economia/v0.1/07_contratos_y_revision.md), [FND05](../../metodo/posicionamiento_demanda_y_conversion/v0.1/06_contratos_y_revision.md), [FND06](../../metodo/medicion_preparacion_y_transferencia/v0.1/07_contratos_y_revision.md) y [FND07](../../metodo/operacion_conversacional/v0.1/06_contrato_y_revision.md). Una recepción es por campo, versión, uso y suficiencia; no es un aprobado de nodo ni una autorización de negocio.
...
|---|---|
| B2B y recorridos A/B; variantes con límites | [Alcance](02_alcance_y_variantes.md), TRA/CAP FND02 y reglas FND04/FND05 |
...
| Conversación y autonomía | [Entrada común](../../metodo/operacion_conversacional/v0.1/ENTRADA_GO2REV.md), guía y rutas; uso sin RevOS o LLM |
| Capacidades y alternativa suficiente | [Capacidades](../../metodo/operacion_conversacional/v0.1/03_capacidades_y_alternativas.md) y [adaptación](../../metodo/operacion_conversacional/v0.1/04_adaptacion_del_entorno.md) |
| Continuidad y conservación | [Continuidad](../../metodo/operacion_conversacional/v0.1/05_continuidad_y_cambios.md) y [versiones del producto](05_versiones_y_mantenimiento.md) |
...
La integración usa las fuentes metodológicas actuales de FND01–FND07. Sus correspondencias identifican los originales Go2Rev, RevOS 4.4.0, GTM Planner 0.3.0 y semillas pertinentes realmente leídos, con alcance y límites. FND08 conserva esos límites; no atribuye una nueva lectura de todo el archivo ni reutilización de motores o documentos no inspeccionados.
