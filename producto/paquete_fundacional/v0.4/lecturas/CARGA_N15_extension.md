...
Procedencia: `producto/metodo/medicion_preparacion_y_transferencia/v0.1/04_materializacion_y_uso.md` · SHA256 `7bbca5115ab1cd0276d3b5e98c0a9b2e0c2dd8144144f61ee86c6fc6f027cb2a` · Incluye: archivo íntegro.

# N15 · Materialización de piezas, medios y guía de uso

Versión 0.1 · Productor de K15

Empezar con la [primera pasada de N15](../../../metodo/operacion_conversacional/v0.3/10_primera_pasada.md#n15) y aplicar [núcleo y suficiencia](../../../metodo/operacion_conversacional/v0.3/12_nucleo_y_suficiencia.md). El procedimiento y contrato siguientes gobiernan el análisis completo.
