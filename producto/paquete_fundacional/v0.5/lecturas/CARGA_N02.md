...
Procedencia: `producto/metodo/encargo_y_conocimiento/v0.1/02_conocimiento_y_solicitud.md` · SHA256 `e6e7a76c81e556f5a7175c39fb3e2877e9ebbac33c6dbbfd4004a9d52112da88` · Incluye: sección Procedimiento de primera pasada íntegra.
...
<a id="fuente-7fb96d5c1dcb"></a>

## Fuente: 03_conocimiento.md

Procedencia: `producto/metodo/encargo_y_conocimiento/v0.1/plantillas/03_conocimiento.md` · SHA256 `c0dbd896354b8f7796b94de60fce0adecf62d64e44d4a6f3285ef5a04ce7dcb3` · Incluye: archivo íntegro.
...
Usar con [N02](../../../metodo/encargo_y_conocimiento/v0.1/02_conocimiento_y_solicitud.md) y [contratos](../../../metodo/encargo_y_conocimiento/v0.1/03_contratos_y_diccionario.md). Las reglas son metadatos; no son afirmaciones de una prestación. Repetir únicamente los registros pertinentes a decisiones materiales. Los bloques pueden separarse en archivos enlazados sin duplicar el contenido.
...
|---|---|
| Al desarrollar una decisión, variante o excepción que los pasos breves no resuelven; antes de usar una fórmula o procedimiento especializado. | [02_conocimiento_y_solicitud](CARGA_N02_extension.md#fuente-37a43622ba0e): Referencia sustantiva pertinente a la pregunta |
| Antes de emitir el resultado a su consumidor; al cambiar entradas, ámbito o uso E/O. | [03_contratos_y_diccionario](CARGA_N02_extension.md#fuente-f221d318f5a1): Contrato K02 y relación de consumo afectada |
| Cuando una aportación exclusiva deba solicitarse; registrar propósito, receptor y resolución. | [02_solicitudes](CARGA_N02_extension.md#fuente-2a1f12e129e5): Bloques aplicables de la plantilla |
| En recorrido A, antes de transferir conocimiento de origen al destino. | [04_transferencia_A](CARGA_N02_extension.md#fuente-c2f3c7f5b892): Bloques aplicables de la plantilla |
| En recorrido B, para distinguir intención, representación y capacidad habilitada. | [05_capacidades_B](CARGA_N02_extension.md#fuente-d47dbecc10df): Bloques aplicables de la plantilla |
| Cuando exista decisión, consumo de un campo o cambio material. | [06_decisiones_y_cambios](CARGA_N02_extension.md#fuente-f6898d2f7995): Bloques aplicables de la plantilla |
| Antes de preparar la recogida o una ampliación al cliente. | [04_intake_diagnostic](CARGA_N02_extension.md#fuente-7f3bce6b9c91): Procedimiento; clasificación, arranque, bloqueo y comunicación pertinentes |
| Al anticipar necesidades o precisar cantidad y calidad de una solicitud. | [05_catalogo_de_informacion](CARGA_N02_extension.md#fuente-7b277a833b8e): Familias aplicables y reglas de cobertura/recepción |
