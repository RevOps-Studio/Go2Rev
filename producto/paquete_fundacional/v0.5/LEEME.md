...
Versión de conjunto 0.5 · 11 de septiembre de 2026 · paquete de implementación
...
| Operación conversacional y entorno | 0.3 | [Entrada y continuidad](../../metodo/operacion_conversacional/v0.3/LEEME.md) |
| Definición estructurada de formatos | 0.1 | [Campos y vistas](../../metodo/esquema/v0.1/LEEME.md) |
| Integración y uso del conjunto | 0.5 | Esta guía y sus archivos asociados |
...
1. Abrir [CARGA_INICIO](lecturas/CARGA_INICIO.md) y la carga del nodo. Consultar [uso por entorno](../../metodo/operacion_conversacional/v0.3/09_uso_por_entorno.md) cuando haya que preparar o adaptar el medio.
2. Preparar una raíz del encargo con la [estructura vacía](Go2Rev_estructura_vacia_v0.5.zip); recuperar la existente si es una continuación.
...
4. Aplicar [primera pasada](../../metodo/operacion_conversacional/v0.3/10_primera_pasada.md), guardar y actualizar el índice. Un chat sin escritura entrega archivos para incorporar al espacio persistente.
