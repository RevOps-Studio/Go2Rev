# Go2Rev · N10 · Extensión por pregunta
...
Procedencia: `producto/metodo/posicionamiento_demanda_y_conversion/v0.1/03_conversion_y_compra.md` · SHA256 `8ebaa19faba26c859c0b18ee2a0d3e908baac618cb6e6dd8ddc91229acd70b04` · Incluye: archivo íntegro.

# N10 · Conversión y recorrido de compra

Versión 0.1 · Productor de K10

Empezar con la [primera pasada de N10](../../../metodo/operacion_conversacional/v0.4/10_primera_pasada.md#n10) y aplicar [núcleo y suficiencia](../../../metodo/operacion_conversacional/v0.4/12_nucleo_y_suficiencia.md). El procedimiento y contrato siguientes gobiernan el análisis completo.
...
Si existen datos pertinentes durante una prestación y la decisión requiere una estimación, usar las [reglas de cohortes y dominio](../../../metodo/posicionamiento_demanda_y_conversion/v0.1/04_costes_cohortes_y_capacidad.md). Separar cantidades acordadas, decisiones abiertas y resultados hipotéticos, con fecha de corte, evidencia y límites. No es obligatorio producir forecast para poder diseñar un proceso ni sumar todos los acuerdos potenciales como capacidad comprometida.
...
<a id="fuente-abdb7e967668"></a>

## Fuente: 06_recepcion_y_seguimiento.md

Procedencia: `producto/metodo/posicionamiento_demanda_y_conversion/v0.1/plantillas/06_recepcion_y_seguimiento.md` · SHA256 `03e85173710ce2f33aa8e4df7b19a1ad6eed4c169f7a6357066ed0610d1a53f1` · Incluye: archivo íntegro.
...
Usar con [conversión y compra](../../../metodo/posicionamiento_demanda_y_conversion/v0.1/03_conversion_y_compra.md). Repetir para traspasos que cambien tarea o responsabilidad. La recepción de un archivo o una notificación emitida no acredita que el receptor pueda asumir el compromiso.
...
Para aceptación comercial e inicio de cumplimiento, usar el [bloque de entrega y traspaso K11](../../../metodo/oferta_entrega_y_economia/v0.1/plantillas/02_entrega_y_traspaso.md). No copiarlo como un contrato comercial alternativo. Los hechos de una prestación se preservarán con la versión que los sustentó.
