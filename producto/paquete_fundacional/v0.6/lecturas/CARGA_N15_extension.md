# Go2Rev · N15 · Extensión por pregunta
...
<a id="fuente-c5b03275171a"></a>

## Fuente: 04_materializacion_y_uso.md

Procedencia: `producto/metodo/medicion_preparacion_y_transferencia/v0.1/04_materializacion_y_uso.md` · SHA256 `139597aa3f5cb08e727d94f5d71e0d7f2f57728fda93206c29e615d752169a9b` · Incluye: archivo íntegro.

# N15 · Materialización de piezas, medios y guía de uso

Versión 0.1 · Productor de K15

Empezar con la [primera pasada de N15](../../../metodo/operacion_conversacional/v0.4/10_primera_pasada.md#n15) y aplicar [núcleo y suficiencia](../../../metodo/operacion_conversacional/v0.4/12_nucleo_y_suficiencia.md). El procedimiento y contrato siguientes gobiernan el análisis completo.
...
Cuando se use el [modelo económico oferta, entrega y economía](../../../metodo/oferta_entrega_y_economia/v0.1/08_guia_del_modelo.md), conservar su dominio. La captura de costes por actividad o relaciones no lineales requiere representación explícita antes de concluir. Exportar un libro o verlo correctamente no acredita recálculo con entradas ni comportamiento en otro motor; N16 especifica esa comprobación en el entorno de prestación.
