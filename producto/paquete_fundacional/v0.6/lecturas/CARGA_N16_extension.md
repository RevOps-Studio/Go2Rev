# Go2Rev · N16 · Extensión por pregunta
...
<a id="fuente-3797bc0c0cc5"></a>

## Fuente: 05_comprobacion_de_preparacion.md

Procedencia: `producto/metodo/medicion_preparacion_y_transferencia/v0.1/05_comprobacion_de_preparacion.md` · SHA256 `8f14ca02e1733d5d0fd0420e7d8be982fadae02425837820bea3018f25a5fbdc` · Incluye: archivo íntegro.

# N16 · Comprobación de preparación

Versión 0.1 · Productor de K16 · Protocolos de futura prestación

Empezar con la [primera pasada de N16](../../../metodo/operacion_conversacional/v0.4/10_primera_pasada.md#n16) y aplicar [núcleo y suficiencia](../../../metodo/operacion_conversacional/v0.4/12_nucleo_y_suficiencia.md). El procedimiento y contrato siguientes gobiernan el análisis completo.
...
No basta marcar una variante presente: identificar la regla, material, condición y observación que la cubre. Los [contratos de oferta, entrega y economía](../../../metodo/oferta_entrega_y_economia/v0.1/07_contratos_y_revision.md) y las [variantes posición, demanda y conversión](../../../metodo/posicionamiento_demanda_y_conversion/v0.1/05_variantes_y_traspasos.md) gobiernan su significado.
...
<a id="fuente-4b946c939ae0"></a>

## Fuente: 07_cobertura_y_preparacion.md

Procedencia: `producto/metodo/medicion_preparacion_y_transferencia/v0.1/plantillas/07_cobertura_y_preparacion.md` · SHA256 `7d0cf768211ba30685eb275cbe83c6ab46b32577bad60b00907b670fb424efb5` · Incluye: archivo íntegro.
...
Usar con [comprobación de preparación](../../../metodo/medicion_preparacion_y_transferencia/v0.1/05_comprobacion_de_preparacion.md). Repetir por obligación/recorrido y conservar la relación entre criterios, observaciones y conclusión. Una proporción de filas cumplidas no compensa una obligación esencial sin cubrir.
