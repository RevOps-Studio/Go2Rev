...
Versión de conjunto 0.6 · Correspondencia de producto
...
**Recogida de información.** N01/N02 conectan la [guía de intake](../../metodo/encargo_y_conocimiento/v0.1/04_intake_diagnostic.md) y el [catálogo](../../metodo/encargo_y_conocimiento/v0.1/05_catalogo_de_informacion.md) con las entradas de Diagnostic y N08–N12 E. HUE/SOL conservan prioridad, momento, cobertura y efecto del bloqueo; la comunicación es una vista, sin un registro paralelo. La cantidad se justifica por uso y cobertura, y las ausencias no impiden el trabajo independiente.
...
| Conversación y autonomía | [Entrada común](../../metodo/operacion_conversacional/v0.4/ENTRADA_GO2REV.md), guía y rutas; uso sin RevOS o LLM |
| Capacidades y alternativa suficiente | [Capacidades](../../metodo/operacion_conversacional/v0.4/03_capacidades_y_alternativas.md) y [adaptación](../../metodo/operacion_conversacional/v0.4/04_adaptacion_del_entorno.md) |
| Continuidad y conservación | [Continuidad](../../metodo/operacion_conversacional/v0.4/05_continuidad_y_cambios.md) y [versiones del producto](05_versiones_y_mantenimiento.md) |
