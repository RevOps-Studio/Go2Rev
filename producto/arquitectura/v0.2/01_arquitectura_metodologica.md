...
La primera base sigue sin validación sustantiva de uso. Un intento de arranque en un encargo real detectó una interferencia metodológica antes de ejecutar Go2Rev; sirve como evidencia del mecanismo de activación, no de los nodos. Las instrucciones, plantillas, modelos y protocolos que desarrollan esta arquitectura se localizan en el [paquete fundacional](../../paquete_fundacional/v0.6/LEEME.md). Los nodos siguientes describen la prestación.
