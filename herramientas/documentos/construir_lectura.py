...
ARCH=ROOT/('producto/paquete_fundacional/v0.6' if IS_GUIDE else 'producto/arquitectura/v0.2')
...
if IS_GUIDE:
    ...
    para('Versión del conjunto 0.6 · 17 de septiembre de 2026')
    ...
    para('La arquitectura conserva diecisiete nodos, contratos y correspondencia con los once pasos de origen. Su desarrollo sustantivo está integrado en el paquete fundacional 0.6. Las pruebas del método se sitúan después del cierre de construcción y requieren un ámbito autorizado; no se atribuye aquí aplicación previa.')
    para('Esta vista reúne los cuatro archivos operativos actuales de arquitectura, con integración editorial del 17 de septiembre de 2026. Las fuentes editables permanecen en producto/arquitectura/v0.2. La vista se regenera desde ellas y conserva el estado teórico del producto.')
...
d.core_properties.subject='Conjunto fundacional v0.6' if IS_GUIDE else 'Arquitectura v0.2'
d.core_properties.author='RevOps Studio'
d.core_properties.comments=''
dest=ARCH/('Go2Rev_guia_de_implementacion_v0.6.docx' if IS_GUIDE else 'Go2Rev_arquitectura_metodologica_v0.2.docx')
d.save(dest)
...
with zipfile.ZipFile(dest,'w',zipfile.ZIP_DEFLATED) as z:
    for n,b in sorted(parts.items()):
        info=zipfile.ZipInfo(n,(2026,9,17,0,0,0));info.create_system=3;info.external_attr=0o100644<<16;info.compress_type=zipfile.ZIP_DEFLATED;z.writestr(info,b)
