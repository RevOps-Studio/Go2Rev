...
`construir_paquete.py` crea el inventario y manifiesto del [paquete vigente](../../producto/paquete_fundacional/v0.4/LEEME.md) y una distribución ZIP en `entregables/`. Utiliza solo las carpetas de versiones actuales enumeradas en el propio constructor y las herramientas documentales expresamente incluidas. Requiere Python y su biblioteca estándar; no ejecuta la metodología, el modelo económico ni los renderizadores.
