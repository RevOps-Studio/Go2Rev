...
[Paquete fundacional v0.4](producto/paquete_fundacional/v0.4/LEEME.md), [guía Word](producto/paquete_fundacional/v0.4/Go2Rev_guia_de_implementacion_v0.4.docx) y [distribución](entregables/Go2Rev_fundacional_v0.4.zip). El paquete contiene las fuentes, plantillas, modelo y derivados. La operación usa su entrada propia, sin cargar maestros ni archivo de procedencia.
