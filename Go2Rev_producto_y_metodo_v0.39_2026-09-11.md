# Go2Rev Producto y método v0.39

11 de septiembre de 2026 · Responsable de producto Carlos Estrada

[Plan v0.50](Go2Rev_plan_de_trabajo_v0.50_2026-09-11.md) · [Evidencias v0.46](Go2Rev_evidencias_y_pruebas_v0.46_2026-09-11.md)
...
La versión actual se distribuye como [paquete fundacional v0.3](producto/paquete_fundacional/v0.3/LEEME.md), con revisión documental del asistente el 11 de septiembre de 2026. Sigue siendo enteramente teórica: no ha habido clientes ni pruebas de la metodología. Conserva la arquitectura de diecisiete nodos aceptada por Carlos; no se atribuye aceptación adicional del cierre. Sus fuentes contienen capacidades generales y campos empresariales vacíos.
...
Venta directa, distribución, autoservicio y combinaciones cambian unidades, roles y traspasos. Producto físico, servicios y recurrencia requieren reglas económicas y de cumplimiento pertinentes. El [alcance de la versión fundacional](producto/paquete_fundacional/v0.3/02_alcance_y_variantes.md) declara las rutas y formas de oferta desarrolladas, sus reglas combinables y límites de automatización; una capacidad efectiva de prestación requiere además recursos y autoridad propios.
...
La base fundacional contiene los métodos, plantillas y [guía de composición y recepción](producto/paquete_fundacional/v0.3/03_entregables_y_recepcion.md) para producir estos conjuntos. Los datos y resultados de una prestación se incorporarán únicamente cuando exista ese encargo, fuera de las fuentes generales del producto.
