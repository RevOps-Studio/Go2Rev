...
La revisión documental conserva cobertura de diecisiete nodos y contratos, campos vacíos y distinción de fuentes/derivados. La puesta en marcha está publicada en la [solicitud de integración 1](https://github.com/RevOps-Studio/Go2Rev/pull/1). El modelo y el conjunto 0.3 se construyen en `mejora/modelo-economico-portable`, desde su commit 272e830, con integración dirigida a la rama anterior.
