...
La autoridad de producto corresponde a los maestros vigentes y a la [arquitectura v0.2](../../../producto/arquitectura/v0.2/01_arquitectura_metodologica.md). Este archivo documenta la procedencia y las adaptaciones de N01/N02. No contiene tareas ni decisiones de una prestación, y no es otro plan maestro.
